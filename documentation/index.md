...
- User Guide
  ...
  - Consensus
    - [Consensus](user-guide/consensus/index.md) — How the consensus plugin deliberates two AI peers over artifacts, briefs, and options, including create, decide, refine, evaluate, iteration modes, and current limitations.
