...
- `backlog/items/*.md` are executable backlog records. `backlog/index.md` and `backlog/completed.md` summarize backlog state; if item files change, run `oat backlog regenerate-index`.
...
- When closing or shipping work: update the backlog record, the completed summary, the project summary, and `current-state.md`; promote durable decisions into `decision-record.md`.
