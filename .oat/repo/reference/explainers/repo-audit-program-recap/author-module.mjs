// author-module for the explainer-kit authorModulePath seam.
// Self-contained: reads nothing at runtime; returns the program recap prose.
// The markdown below is identical to recap.md in this directory.

const CONTENT = `# Repo-Audit Execution Program — Recap
