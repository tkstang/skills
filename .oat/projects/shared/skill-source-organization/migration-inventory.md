...
- Complexity-review source: the same personal-skills revision, `src/skills/complexity-review/SKILL.md` plus `references/evidence-guide.md`, version `1.0.2`. Execution reverified the pinned commit and promoted that prompt-only content to the public owner at version `1.0.2` under this repository's MIT license with Thomas Stang attribution. The personal repository's `external-skills.json` does not externalize either owner yet; the later private cutover remains p05 work.
...
| `skills/complexity-review` plus newer personal source | public 1.0.2; personal 1.0.2 | `src/skills/complexity-review` | standalone `skills/complexity-review` | `complexity-review` | prompt-only; no `build.json`, runtime, or empty `src` directory |
...
task_format_paths=(
  ...
  'src/tools/coding-session-handoff/behavior-contracts.ts'
  'src/tools/coding-session-handoff/behavior-gate.test.ts'
  'src/tools/coding-session-handoff/behavior-gate.ts'
  'src/tools/coding-session-handoff/cli.test.ts'
  'src/tools/coding-session-handoff/cli.ts'
  ...
  'src/tools/coding-session-handoff/handoff.ts'
  ...
  'src/tools/coding-session-handoff/providers.ts'
  ...
  'src/skills/session-observer-collab/src/codex-lifecycle.d.mts'
  'src/skills/session-observer-collab/src/codex-lifecycle.mjs'
  'src/skills/session-observer-collab/src/collab-control.d.mts'
  ...
  'src/skills/session-observer-collab/src/hooks/codex-stop.d.mts'
  'src/skills/session-observer-collab/src/hooks/codex-stop.mjs'
  'src/skills/session-observer-collab/src/hooks/cursor-stop.d.mts'
  'src/skills/session-observer-collab/src/hooks/cursor-stop.mjs'
  'src/skills/session-observer-collab/src/lib/codex-install.d.mts'
  'src/skills/session-observer-collab/src/lib/codex-install.mjs'
  'src/skills/session-observer-collab/src/lib/completion-selection.d.mts'
  'src/skills/session-observer-collab/src/lib/completion-selection.mjs'
  'src/skills/session-observer-collab/src/lib/lease-state.d.mts'
  'src/skills/session-observer-collab/src/lib/lease-state.mjs'
  'src/skills/session-observer-collab/src/lib/runtime-adapter.d.mts'
  'src/skills/session-observer-collab/src/lib/runtime-adapter.mjs'
  'src/skills/session-observer-collab/src/lib/selected-prefix.d.mts'
