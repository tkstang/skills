...
| p04    | code     | fixes_added | 2026-07-12 | review-fix 1/4 code fixes complete; shipped hook installed; live matrix awaits exact registration, trust, and peer sessions |
| p05    | code     | pending | -    | -        |
| p06    | code     | pending | -    | -        |
| final  | code     | pending | -    | -        |
