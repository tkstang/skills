...
oat_project_state_updated: "2026-07-23T16:10:25Z" # ISO 8601 UTC timestamp — updated on every state.md mutation
oat_generated: false
---
...
- ⧗ `p02-t07` raw cwd alias containment next
...
Execute `p02-t07` and `p02-t08`, then run the one authorized
