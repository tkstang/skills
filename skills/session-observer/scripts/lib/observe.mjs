...
export function parsePinnedSession(session) {
...
export function shouldMarkCatchUpRead(sessionState, digest) {
...
export async function applySnippetFilter(candidates, snippet) {
