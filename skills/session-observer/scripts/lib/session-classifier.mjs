 ...
 * @returns {object}
 */
export function classifyTranscriptRecords(runtime, records) {
 ...
 */
export async function classifyTranscript(runtime, transcriptPath) {
 ...
 * @returns {object}
 */
export function engagementCandidateFields(classification) {
  return {
