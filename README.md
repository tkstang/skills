...
Five standalone skills cover observing sessions, exporting transcripts,
experimental handoff guidance, collaboration, and complexity review.
...
| `coding-session-handoff`    | Experimental, not released: prepare destination-safe fork guidance from bounded, explicit session evidence; it does not invoke a provider or create a fork |
