...
} from '../../skills/session-fork-to-destination/src/discovery.js';
import { validateHandoffTarget } from '../../skills/session-fork-to-destination/src/git-target.js';
import {
  previewHandoffCandidates,
  type PreviewSource,
} from '../../skills/session-fork-to-destination/src/preview.js';
import {
  HANDOFF_COMMANDS,
  parseBatchOutcome,
...
import {
  ClassificationCache,
  discover,
} from '../../skills/session-observer/src/lib/locate.js';
import type { TranscriptCandidate } from '../../skills/session-observer/src/lib/types.js';
