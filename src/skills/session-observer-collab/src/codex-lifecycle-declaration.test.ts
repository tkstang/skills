...
const lifecyclePath = new URL('./codex-lifecycle.mjs', import.meta.url);
const declarationPath = new URL('./codex-lifecycle.d.mts', import.meta.url);

describe('Codex lifecycle types', () => {
